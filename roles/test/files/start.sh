...
scp -i /home/ubuntu/ansibles/roles/test/files/sp-member.pem /var/lib/jenkins/workspace/test/build/libs/sp-0.0.1-SNAPSHOT.jar ~/ansibles/roles/test/files/stop.sh ubuntu@15.165.213.153:~/app
